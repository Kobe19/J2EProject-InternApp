...
/**
 * Servlet Interns that first will check if the session exist. If it exist we check if the user exists and then we can redirect  
 * the tutor to the internList.jsp where the tutor can see the list of the interns assigned to him and their interships
 * If the session does not exist or the user is null, we redirect to the rooter servlet
 * @author Tristan CLEMENCEAU
 */
public class Interns extends HttpServlet {

    /**
     * Processes requests for both HTTP <code>GET</code> and <code>POST</code>
     * methods.
     * We check if the session exist. If it exist we check if the user exists and then we load the data 
     * so the tutor can see the list of the interns assigned to him and their interships
     * If the session does not exist or the user is null, we redirect to the rooter servlet
